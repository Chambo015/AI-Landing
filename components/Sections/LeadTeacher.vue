<template>
    <section class="overflow-hidden relative ">
        ...
        <div class="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black h-20"></div>
    </section>
</template>
